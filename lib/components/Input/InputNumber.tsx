...
export interface InputNumberProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'size' | 'defaultValue' | 'onChange'> {
...
const InputNumber: React.FunctionComponent<InputNumberProps> = ({className, width, size, controls, precision, step, min, max, onChange, defaultValue, disabled, ...restProps}) => {
